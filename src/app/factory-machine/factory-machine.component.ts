...
@Component({
  ...
  styleUrls: ['./factory-machine.component.scss']
})
export class FactoryMachineComponent  implements OnInit, AfterViewInit {
   ...
   // console.log(' this.emissiveData =====>', this.emissiveData )
    ...
    this.rootDiv.append(img);
     ...
     // labelDiv.append(addCircle);
      ...
      label.visible = false;
      tooth.add(label);
  if(tooth.name == 'New_project006' || tooth.name ==  'New_project007'|| tooth.name == 'New_project038' || tooth.name == 'New_project027')
