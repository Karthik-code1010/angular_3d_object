...
@Component({
  selector: 'app-jeep-object',
  templateUrl: './jeep-object.component.html',
  styleUrls: ['./jeep-object.component.scss']
})
export class JeepObjectComponent implements OnInit  {
  ...
  createMesh(): void {
    ...
    this.loaderGLTF.load('assets/robot/scene.gltf',
      obj => {
        ...
        this.teeth = obj.scene.children     
        console.log( 'first half',this.teeth)

        console.log( 'first half group',this.teeth[0].children[0].children[0].children)
        
     



        this.toothMaterial = this.teeth[0].children[0].children[0].children[0].children[0].children[0].material;

        console.log('this.teeth=>',this.teeth[0]);
        console.log('this.toothMaterial',this.toothMaterial)

        this.highlightedToothMaterial = this.teeth[0].children[0].children[0].children[0].children[0].children[0].material.clone();

        console.log('clone', this.highlightedToothMaterial )
        this.highlightedToothMaterial.emissive.setHex(0xffff00);
        console.log('emissive', this.highlightedToothMaterial )
        this.selectedToothMaterial = this.teeth[0].children[0].children[0].children[0].children[0].children[0].material.clone();
        this.selectedToothMaterial.emissive.setHex(0x00ff00);

        console.log('selectedToothMaterial',this.selectedToothMaterial)
        let example:any = new THREE.Object3D();
        this.teeth[0].children[0].children[0].children.forEach((element:any) => {
